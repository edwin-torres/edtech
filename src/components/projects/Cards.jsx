...
import { fronts, backs } from "../../assets/images"; // ✅ import from index.js
...
export default function QuadraticFlashcards() {
  // ✅ now pulls from index.js
  const initialCards = Array.from({ length: 8 }, (_, i) => ({
    id: i + 1,
    imageFront: fronts[`quadFront${i + 1}`],
    imageBack: backs[`quadBack${i + 1}`],
  }));
